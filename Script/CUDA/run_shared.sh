...
nvc++ -I/home/stud/esame/hpc/eigen -D USE_SHARED_MEMORY --diag_suppress code_is_unreachable -o matrix_SHARED Matrix_shared_version.cu

# File di output per i risultati
output_file="risultati_use_shared_memory_32_3000.txt"
> $output_file
...
do
    ...
    do
        ...
        do
            ...
            ./matrix_SHARED 10 10 >> temp_output.txt 2>&1
