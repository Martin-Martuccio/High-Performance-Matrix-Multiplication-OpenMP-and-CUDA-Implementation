...
nvc++ -I/home/stud/esame/hpc/eigen -D USE_PITCHED_MEMORY --diag_suppress code_is_unreachable -o matrix_GLOBAL matrix_works.cu

# File di output per i risultati
output_file="risultati_use_pitched_memory_1000.txt"
> $output_file
    ...
    do
        ...
        then
            ...
            do
                ...
                ./matrix_GLOBAL $threadSizeX $threadSizeY >> temp_output.txt 2>&1
